...
static PyMethodDef __pyx_mdef_12compute_hist_1compute_hist_func = {"compute_hist_func", (PyCFunction)__pyx_pw_12compute_hist_1compute_hist_func, METH_VARARGS|METH_KEYWORDS, 0};
  ...
  __Pyx_RefNannySetupContext("compute_hist_func (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_angle_arr)) != 0)) kw_args--;
        else {
        ...
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_num_pixels)) != 0)) kw_args--;
        else {
 ...
 * 					 np.ndarray[float, ndim=1, mode="c"] hist not None,
 */
  __pyx_tuple__10 = PyTuple_Pack(5, __pyx_n_s_mag_arr, __pyx_n_s_angle_arr, __pyx_n_s_hist, __pyx_n_s_num_pixels, __pyx_n_s_num_bins); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(5, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_compute_hist_pyx, __pyx_n_s_compute_hist_func, 15, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcompute_hist(void); /*proto*/
PyMODINIT_FUNC initcompute_hist(void)
#else
PyMODINIT_FUNC PyInit_compute_hist(void); /*proto*/
PyMODINIT_FUNC PyInit_compute_hist(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_compute_hist(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  int __pyx_t_1;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_compute_hist(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init compute_hist", 0, __pyx_lineno, __pyx_filename);
    }
