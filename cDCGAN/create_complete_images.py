"""CreateCompleteImages

This module serves to create a set of images by stitching together black background with randomly distributed star
patches generated by a generative model; additionally, it scores these images using a Random Forest and neural network
classifier and may also find a good random distribution.
This module takes the following arguments:
optional:
--checkpoint_path Whole path to checkpoint file ending with .data-00000-of-00001
--nn_path Whole path to classfier nn checkpoint file ending with .data-00000-of-00001'
--rf_path Whole path rf model (.pkl)
--find_good_latents True: Loop infinitely to find good random latents and poisitions for the generated images.
                    False: Create one set of images and score it.
--min_score Only save latents and images for scores above min_score.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--min_score', type=float, default=2.9486,
                        ...
                        help="Only save latents and images for scores above min_score.")
